...
export default function Dashboard() {
  return <div className="matos-page">
    <style>{`
      ...
      .matos-phone .mx-auto{max-width:none!important;width:100%!important}
      ...
      @media (min-width:768px){.matos-phone{padding:clamp(18px,2.5vw,32px)}}
      @media (min-width:1200px){.matos-phone{padding:28px 4vw}.matos-phone>div{max-width:none!important}#tutorial{max-width:1400px}}
      @media (max-width:430px){.matos-phone{padding:8px}}
      @media (orientation:landscape) and (max-height:600px){.matos-phone{padding:8px 12px}}
    `}</style>
