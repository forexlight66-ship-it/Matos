...
export default function Dashboard() {
  ...
  return (
    <div className="matos-page">
      <style>{`
        .dashboard-head{display:flex;align-items:center;justify-content:space-between;padding:12px 16px 0}
        .dashboard-brand{display:flex;align-items:center;gap:9px;color:var(--t1);font:700 18px 'Space Grotesk'}
        .dashboard-brand i{display:flex;width:36px;height:36px;border-radius:11px;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--blue),#2350B8);color:#fff;font-style:normal}
