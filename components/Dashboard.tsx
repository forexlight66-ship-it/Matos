  ...
  return (
    <div className="matos-page">
      <style>{`
        ...
        .dashboard-actions{display:flex;gap:6px;align-items:center;position:relative}.theme-btn,.dots-btn{border:1px solid #294b78!important;background:#071936!important;color:#fff!important;border-radius:8px!important;cursor:pointer;font-size:12px;font-weight:600}.theme-btn{padding:8px 9px}.dots-btn{width:34px;height:34px;font-size:18px}.dashboard-menu{position:absolute;right:0;top:40px;z-index:80;width:160px;padding:6px;border:1px solid #294b78!important;background:#071936!important;border-radius:8px!important;box-shadow:0 18px 35px -12px #000}.dashboard-menu button{width:100%;border:0;background:transparent!important;color:#fff!important;padding:9px;text-align:left;border-radius:6px;cursor:pointer;font-size:11px}.dashboard-menu button:hover{background:#0d2347!important}
        /* WhatsApp: original SVG logo, green and centered correctly. Button background matches Deriv dark background. */
        .matos-phone .av4 .whatsapp-header{width:38px!important;height:38px!important;min-width:38px!important;min-height:38px!important;flex:0 0 38px!important;padding:0!important;border-radius:10px!important;background:#071936!important;display:flex!important;align-items:center!important;justify-content:center!important;box-sizing:border-box!important;color:#25D366!important;line-height:0!important;text-decoration:none!important;overflow:hidden!important}
        .matos-phone .av4 .whatsapp-header:hover{background:#0d2347!important}
        .matos-phone .av4 .whatsapp-header svg{display:block!important;width:19px!important;height:19px!important;fill:#25D366!important;color:#25D366!important}
        .matos-phone .av4 .whatsapp-header svg path{fill:#25D366!important}
        .matos-phone .av4 .whatsapp-header:before{display:none!important;content:none!important}
