  ...
  return (
    <div className="matos-page">
      <style>{`
        ...
        /* WhatsApp/header actions intentionally hidden; the header now uses the same clean background as the platform. */
        .matos-phone .av4 .header-actions{display:none!important}
        .matos-phone .av4 .whatsapp-header{display:none!important}
