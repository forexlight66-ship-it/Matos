...
export default function Dashboard() {
  ...
  return <div className="matos-page">
    <style>{`
      /* Responsive full-screen layout: phone, tablet and desktop */
      ...
      @media (min-width:1200px){.matos-phone{padding:28px 4vw}.mode-switch-matos{max-width:900px}#tutorial{max-width:1400px}}
      @media (max-width:430px){.matos-phone{padding:8px}.mode-switch-matos{margin-bottom:10px}}
