  ...
  return (
    <div className="robot-page">
      <style>{`
        ...
        .symbol{padding:13px 14px;display:flex;align-items:center;justify-content:space-between;font-size:13px;font-weight:800}.select{width:100%;background:transparent;border:0;outline:0;color:var(--rhi);font-weight:800;font-size:13px}.select option{background:#111823;color:#fff}.duration{display:flex;gap:8px;margin-top:7px}.duration button{flex:1;padding:12px 4px;border-radius:11px;border:1px solid var(--rline);background:var(--rbg1);color:var(--rmid);font-family:ui-monospace,SFMono-Regular,monospace;font-size:12px;font-weight:800;cursor:pointer}.duration button.on{background:linear-gradient(135deg,#3a6fc9,var(--rblue));color:#fff;border-color:#5a9af5}.duration button:disabled{opacity:.55;cursor:not-allowed}
