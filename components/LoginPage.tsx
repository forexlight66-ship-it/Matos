...
const css: Record<string, React.CSSProperties> = {
  ...
  card: { position: 'relative', zIndex: 2, width: 'min(100%, 430px)', padding: '30px 24px 24px', borderRadius: 28, background: 'linear-gradient(180deg, rgba(19,28,48,.96), rgba(10,15,28,.98))', border: '1px solid #facc15', boxShadow: '0 35px 90px rgba(0,0,0,.55), inset 0 1px 0 rgba(255,255,255,.05)', backdropFilter: 'blur(20px)' },
